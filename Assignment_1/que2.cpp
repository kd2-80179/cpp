...
void printconsoleinitdate(struct Date *ptrdate)
{
  std:: cout<< "in initial date function\n";
    ptrdate->day=0;
    ptrdate->month=0;
    ptrdate->year=0;
...
{
    std::cout<<"in print Date on console function \n";
   std:: cout <<"Date is %d-%d-%d\n",ptrDate->day,ptrDate->month,ptrDate->year;
